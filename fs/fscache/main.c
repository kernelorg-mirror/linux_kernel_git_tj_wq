...
/*
 * Describe an object for slow-work debugging.  It's safe to
 * dereference the object even while the work is running.  Please read
 * the comment above fscache_put_object_after_exec() for details.
 */
...
/*
 * Describe an operation for slow-work debugging.  Ditto for
 * dereferencing.  Read the comment above fscache_put_op_after_exec().
 */
